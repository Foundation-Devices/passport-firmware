// Autogenerated; see tools/se_config_gen

// bytes [16..84) of chip config area
#define SE_CHIP_CONFIG_1 { \
	0xe1, 0x00, 0x61, 0x00, 0x00, 0x00, 0x8f, 0x80, 0x8f, 0x80,   \
	0x8f, 0x43, 0xaf, 0x80, 0x00, 0x43, 0x00, 0x43, 0x8f, 0x80,   \
	0x00, 0x00, 0xc3, 0x43, 0x00, 0x43, 0x00, 0x00, 0x00, 0x00,   \
	0x00, 0x00, 0x8f, 0x4e, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff,   \
...
#define SE_CHIP_CONFIG_2 { \
	0x02, 0x15, 0x00, 0x00, 0x00, 0x00, 0x3c, 0x00, 0x5c, 0x00,   \
	0xbc, 0x01, 0xfc, 0x01, 0xbc, 0x01, 0x9c, 0x01, 0x9c, 0x01,   \
	0xbc, 0x01, 0x3c, 0x00, 0xdc, 0x03, 0x9c, 0x01, 0x3c, 0x00,   \
	0x3c, 0x00, 0x3c, 0x00, 0xdc, 0x01, 0x3c, 0x00   \
}


// key/slot usage and names
#define KEYNUM_pairing_secret      	1
#define KEYNUM_pin_stretch         	2
#define KEYNUM_pin_hash            	3
#define KEYNUM_pin_attempt         	4
#define KEYNUM_lastgood            	5
#define KEYNUM_match_count         	6
#define KEYNUM_supply_chain        	7
#define KEYNUM_seed                	9
#define KEYNUM_user_fw_pubkey      	10
#define KEYNUM_firmware_hash       	14
...
KeyConfig[6] = 0x9c01 = KeyConfig(Private=0, PubInfo=0, KeyType=7, Lockable=0, ReqRandom=0, ReqAuth=1, AuthKey=1, PersistentDisable=0, RFU=0, X509id=0)=0x019c
     ...
     Slot[7] = 0x8f80 = SlotConfig(ReadKey=15, NoMac=0, LimitedUse=0, EncryptRead=0, IsSecret=1, WriteKey=0, WriteConfig=8)=0x808f
KeyConfig[7] = 0xbc01 = KeyConfig(Private=0, PubInfo=0, KeyType=7, Lockable=1, ReqRandom=0, ReqAuth=1, AuthKey=1, PersistentDisable=0, RFU=0, X509id=0)=0x01bc

     Slot[8] = 0x0000 = SlotConfig(ReadKey=0, NoMac=0, LimitedUse=0, EncryptRead=0, IsSecret=0, WriteKey=0, WriteConfig=0)=0x0000
KeyConfig[8] = 0x3c00 = KeyConfig(Private=0, PubInfo=0, KeyType=7, Lockable=1, ReqRandom=0, ReqAuth=0, AuthKey=0, PersistentDisable=0, RFU=0, X509id=0)=0x003c
...
KeyConfig[9] = 0xdc03 = KeyConfig(Private=0, PubInfo=0, KeyType=7, Lockable=0, ReqRandom=1, ReqAuth=1, AuthKey=3, PersistentDisable=0, RFU=0, X509id=0)=0x03dc
     ...
     Slot[10] = 0x0043 = SlotConfig(ReadKey=0, NoMac=0, LimitedUse=0, EncryptRead=0, IsSecret=0, WriteKey=3, WriteConfig=4)=0x4300
...
KeyConfig[13] = 0x3c00 = KeyConfig(Private=0, PubInfo=0, KeyType=7, Lockable=1, ReqRandom=0, ReqAuth=0, AuthKey=0, PersistentDisable=0, RFU=0, X509id=0)=0x003c
     ...
     Slot[14] = 0x8f4e = SlotConfig(ReadKey=15, NoMac=0, LimitedUse=0, EncryptRead=0, IsSecret=1, WriteKey=14, WriteConfig=4)=0x4e8f
