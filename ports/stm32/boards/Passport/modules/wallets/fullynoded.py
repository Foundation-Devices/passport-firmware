...
FullyNodedWallet = {
    ...
    'export_modes': [
        ...
        {'id': 'microsd', 'label': 'microSD', 'filename_pattern': '{sd}/{xfp}-fullynoded.json', 'filename_pattern_multisig': '{sd}/{xfp}-fullynoded-multisig.json', 'mulitsig_config_export_mode': 'microsd'}
    ]
}
