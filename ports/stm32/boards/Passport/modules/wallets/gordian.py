...
#
# gordian.py - Gordian wallet support
#
...
GordianWallet = {
    ...
    'export_modes': [
        {'id': 'qr', 'label': 'QR Code', 'qr_type': QRType.UR2, 'mulitsig_config_export_mode': 'qr'},
        {'id': 'microsd', 'label': 'microSD', 'filename_pattern': '{sd}/{xfp}-gordian.json', 'filename_pattern_multisig': '{sd}/{xfp}-gordian-multisig.json', 'mulitsig_config_export_mode': 'microsd'}
    ]
}
