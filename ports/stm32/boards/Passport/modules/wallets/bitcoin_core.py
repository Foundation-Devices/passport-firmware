...
#
# bitcoin_core.py - Bitcoin Corek wallet
#
...
def create_bitcoin_core_export(sw_wallet=None, addr_type=None, acct_num=0, multisig=False, legacy=False):
    import ustruct
...
BitcoinCoreWallet = {
    ...
    'export_modes': [
        {'id': 'microsd', 'label': 'microSD', 'filename_pattern': '{sd}/{xfp}-passport-bitcoin-core.txt', 'ext': '.txt',
