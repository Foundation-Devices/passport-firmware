...
SparrowWallet = {
    ...
    'export_modes': [
        ...
        {'id': 'microsd', 'label': 'microSD', 'filename_pattern': '{sd}/{xfp}-sparrow.json', 'filename_pattern_multisig': '{sd}/{xfp}-sparrow-multisig.json', 'mulitsig_config_export_mode': 'microsd'}
    ]
}
